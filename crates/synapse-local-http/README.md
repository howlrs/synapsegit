...
explicit empty-target boolean confirmation, and a browser confirmation. Both
operations use the existing queued/polled job. A restored result remains on the
