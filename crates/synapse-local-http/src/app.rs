...
use crate::handlers::{
    ...
    api_decide_creator_session, api_health, api_operation, api_project_reflog, api_project_refs,
    api_project_status, api_projects, api_start_archive_export, api_start_archive_restore,
    api_start_fsck, derive_page, index_page, method_not_allowed, not_found, project_page,
    session_page,
};
...
pub(crate) fn build_with_identity(
    ...
    let router = Router::new()
        ...
        .route(
            "/api/v1/projects/{project_key}/archive-restores",
            axum::routing::post(api_start_archive_restore),
        )
